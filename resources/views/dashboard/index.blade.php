                ...
                <div class="row">
                    ...
                    <div class="col-8">
                        ...
                        <div style="text-align:right;">
                            <p style="font-weight:bold;">{{ $storeCount }}</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 card card_div">
                <div class="row">
                    ...
                    <div class="col-8">
                        ...
                        <div style="text-align:right;">
                            <p style="font-weight:bold;">{{ $customerCount }}</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 card card_div">
                <div class="row">
                    ...
                    <div class="col-8">
                        ...
                        <div style="text-align:right;">
                            <p style="font-weight:bold;">{{ number_format($totalSummation, 2) }}</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 card card_div">
                <div class="row">
                    ...
                    <div class="col-8">
                        ...
                        <div style="text-align:right;">
                            <p style="font-weight:bold;">{{ number_format($totalSummationSub, 2) }}</p>
                        </div>
                    </div>
                </div>
            </div>
...
@section('script')
    <script>
        ...
        // بيانات المبيعات لكل شهر
        // const salesData = @json($formattedSalesData);

        // const chartData1 = {
        //     labels: Object.keys(salesData), // الأشهر
        //     datasets: [{
        //         label: 'عدد المبيعات لكل شهر',
        //         data: Object.values(salesData), // عدد المبيعات
