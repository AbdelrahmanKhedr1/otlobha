<div class="col-12 pe-5 ps-5 pt-3 pb-3">
    <div class="col-12 pe-5 ps-5 pt-3 pb-3">
        <div class="input-group">
            <input type="text" wire:model.live='search' class="form-control" placeholder="ابحث عن مشترك..." aria-label="ابحث عن مطعم">
            ...
            <a href="{{ route('subscription.index') }}">
                <button style="border-radius: 5px" class="btn btn-outline-success me-1">المشتركين</button>
            </a>
        </div>
